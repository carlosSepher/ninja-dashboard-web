...
export const PaymentOrdersPage = () => {
  ...
  }, [filters.buyOrder, filters.dateRange.from, filters.dateRange.to, filters.environment, filters.status, page]);

  useEffect(() => {
    setPage(1);
  }, [filters.dateRange.from, filters.dateRange.to, filters.environment, filters.status, filters.buyOrder]);
